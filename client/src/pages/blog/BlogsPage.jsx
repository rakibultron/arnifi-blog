...
import { Input } from "@/components/ui/input";
import BlogsUnavailable from "@/components/blogs/BlogsUnavailable";
...
export default function BlogSection() {
  ...
  const manageSearch = () => {
    ...
    if (selectedCategory !== "all") {
      filters.category = selectedCategory; // Add category filter only if it's not "all"
    }
    if (author) {
      filters.author = author; // Add author filter if provided
    }
    getBlogs(filters);
  };

  useEffect(() => {
    manageSearch(); // Trigger search whenever filters change
